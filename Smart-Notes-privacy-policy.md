...
We do NOT collect, store, or transmit your personal information or notes to any external servers
All your data stays on your device
We do NOT sell, share, or rent your information to third parties
The only external service we use is Google AdMob for displaying advertisements
...
Usage Data: We do NOT collect analytics, usage statistics, or tracking data about how you use the app.

Location Data: We do NOT collect or access your location information.

### 3. Permissions Explained
The App requests the following permissions:

**Camera Permission (android.permission.CAMERA)**  
Purpose: Allows you to take photos directly within the app to add to your notes  
Usage: Photos are captured only when you explicitly choose to take a photo  
Storage: Photos are stored locally on your device only  
Access: We do NOT access, upload, or share your photos  
**Photo Library/Storage Permission (READ_EXTERNAL_STORAGE)**    
Purpose: Allows you to select existing images from your device gallery to add to notes  
Usage: Only accessed when you choose to add an image to a note  
Storage: Selected images are referenced locally on your device  
Access: We do NOT access other files on your device  
**Internet Permission**    
Purpose: Required only for displaying advertisements through Google AdMob  
Usage: Your notes and content are NEVER transmitted over the internet  
Data: Only anonymous ad-related data is transmitted to AdMob  
**Vibrate Permission**    
...
Privacy Policy: AdMob Privacy Policy  
...
All notes, images, and app data are stored in your device's local storage
...
Our App does not knowingly collect information from children under 13 years of age. Since we do not collect any data, the app is safe for all ages. If you believe a child has provided information to us, please contact us, though note that we do not collect or store such information.

### 9. Your Rights
Since all data is stored locally on your device:

Access: You have full access to all your data within the app
Delete: You can delete any note or image at any time
...
The App is available worldwide. Since we do not collect or transmit your data:
...
✅ Only AdMob collects anonymous advertising data

✅ Camera/Photos are used only for adding images to notes
